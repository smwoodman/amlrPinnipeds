    ...
    mutate(loc_clean = str_replace_all(stri_escape_unicode(location), "[.]", ""),
           ...
           location =
             case_when(
               ...
               loc_lower %in% tolower(c("E Chungungo", "Chung E high", "Chung (E)", "Chung(E)", "Chung-E", "Chung E", "Chungungo east", "Chin E")) ~ "Chungungo East",
               ...
               loc_lower %in% tolower(c("Cop Flats", "Copi flats", "Copi Fl", "Copi F", "Copi-flats", "Copihue slope", "Plan Copihue", "Plan Vero", "Planicie Copihue", "Flats Copihue", "Flats Copihue", "Plan Copi", "Cop F", "Copihue Flats", "Copihue plano")) ~ "Copi Flats",
               ...
               loc_lower %in% tolower(c("P Yuseff", "ML/P Yusseff", "P Yusseff", "Punta Yuseff")) ~ "Punta Yuseff",
