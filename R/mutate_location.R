    ...
    mutate(loc_clean = str_replace_all(stri_escape_unicode(location), "[.]", ""),
           ...
           location =
             case_when(
               ...
               loc_lower %in% tolower(c("Chung Flats", "Chung Flat", "Chun Flats", "Chung Fl", "Chung flat C", "Plan Chungungo", "Chung F", "Chu Flat", "Chu FC", "Chung F C", "Chung C flat", "Chungunga Flat", "Chung Fts C", "chungungo flats", "chung-flat", "Flats Chungungo", "Flats Chungungo", "Planicie Chungungo", "Chung flats C", "Ch Flats", "Behind Chung-flats", "Chung-flats")) ~ "Chungungo Flats",
               ...
               loc_lower %in% tolower(c("Mad (W)", "Mad-w", "Mad w", "Mad(W)", "Madw")) ~ "Maderas West",
               ...
               loc_lower %in% tolower(c("Mad-r", "Mad R", "Mad Ridge", "Maderas Rdg", "HD R?", "Mad B", "madridge", "Mad-ridge")) ~ "Maderas Ridge",
