    ...
    mutate(loc_clean = str_replace_all(stri_escape_unicode(location), "[.]", ""),
           ...
           location =
             case_when(
               ...
               loc_lower %in% tolower(c("Antarctica", "Playa Antarctica", "Pl Antarctica", paste0("Ant", "\\u00e1", "rtico"), "P Antarctico", " P Antarctica", "P Antarctica", "Antartica", "Antarctico", "PAntarctica")) ~ "Antartico",
               ...
               loc_lower %in% tolower(c("Ballena flats", "Ball Fl", "Ballena Fl", "B Norte flats", "BNorte Flats", "Ballena N Flats", "Ballena Centra Flats", "Flats Ballenas", "Flats Ballena Norte", "Planicie Ballena norte", "Ballena F", "Ballena W", "Ballena", "B Sur Flat")) ~ "Ballena Flats",
               ...
               loc_lower %in% tolower(c("Cach", "Cach slope", "Cacheros", "Cacharros", "Cach/Chung", "Cachomos", "Mad/Cach", "Cad/Mad pt", "Cach-hill")) ~ "Cachorros",
               loc_lower %in% tolower(c("Cach (E)", "Cach(E)", "Cach-E", "Cach E", "Cach C/E", "Cachorros E", "E Cach", "Cache")) ~ "Cachorros East",
               loc_lower %in% tolower(c("Cach-C", "Cach C", "Cachc")) ~ "Cachorros Central",
               loc_lower %in% tolower(c("Cach-W", "Cach W", "CachW")) ~ "Cachorros West",
               ...
               loc_lower %in% tolower(c("Chugungo", "Chungung", "Chango", "Chung high", "Chung", "Chun", "Chungungu", "Chungunga", "Chung/Ballena", "Chu", "Chung-PTT")) ~ "Chungungo",
               ...
               loc_lower %in% tolower(c("Chung-C", "Chu C", " Chung C/W", "Chung C", "Chungungo C", "Chun C", "ChungC")) ~ "Chungungo Central",
               loc_lower %in% tolower(c("Chungungo W", "Chung W", "Chung-W", "Chu W", "ChungW")) ~ "Chungungo West",
               loc_lower %in% tolower(c("Chung Flats", "Chung Flat", "Chun Flats", "Chung Fl", "Chung flat C", "Plan Chungungo", "Chung F", "Chu Flat", "Chu FC", "Chung F C", "Chung C flat", "Chungunga Flat", "Chung Fts C", "chungungo flats", "chung-flat", "Flats Chungungo", "Flats Chungungo", "Planicie Chungungo", "Chung flats C", "Ch Flats", "Behind Chung-flats", "Chung-flats", "Chugungo F")) ~ "Chungungo Flats",
               loc_lower %in% tolower(c("Chung Flats E", "Chu F E", "Chung F E", "Chung E Flats", "Chung flat E", "Chung E flat", "Chu FE")) ~ "Chungungo East Flats",
               ...
               loc_lower %in% tolower(c("CopiHue High", "Copi Hue", "copihue")) ~ "Copihue",
               loc_lower %in% tolower(c("Cop", "Copi", "Copi high", "Copi C Knoll", "Copi S", "Copi-PTT")) ~ "Copi",
               loc_lower %in% tolower(c("Copi-E", "Copi E")) ~ "Copi East",
               loc_lower %in% tolower(c("Copi-C", "Copi C", "Copi C/E", "Copi C high", "Copi-C/W", "Copic")) ~ "Copi Central",
               loc_lower %in% tolower(c("Cop-W", "Copi-W", "Copi W", "CopiW")) ~ "Copi West",
               loc_lower %in% tolower(c("Cop Flats", "Copi flats", "Copi Fl", "Copi F", "Copi Flat", "Copi-flats", "Copihue slope", "Plan Copihue", "Plan Copi-Maderas", "Plan Vero", "Planicie Copihue", "Flats Copihue", "Flats Copihue", "Plan Copi", "Cop F", "Copihue Flats", "Copihue plano", "copiflats", "cachi-flat", "chachi-flat")) ~ "Copi Flats",
               ...
               loc_lower %in% tolower(c("Copi Saddle", "Copi ridge", "Copi R", "Hue Ridge", "Copi C Ridge", "Copi W ridge", "Copi WR")) ~ "Copi Ridge",

               loc_lower %in% tolower(c("Co Delfin")) ~ "Delfin",

               loc_lower %in% tolower(c("Hue", "Hue wE", "Hue-PTT")) ~ "Hue",
               ...
               loc_lower %in% tolower(c("Broken Arrow", "B Arrow")) ~ "Cerro Parmenio",
               ...
               loc_lower %in% tolower(c("Mad", "Mad S", "Mad N", "Mad high", "Mad (M)", "Mad-A", "Mad slope", "Md Der?", "maderas")) ~ "Maderas",
               loc_lower %in% tolower(c("Mad (E)", "Mad(E)", "Mad-E", "Mad E high", "Mad E", "Maderas E")) ~ "Maderas East",
               loc_lower %in% tolower(c("Mad (C)", "Mad(C)", "Mad-C", "Mad C", "Mad C/W", "Mad E/C", "MadC")) ~ "Maderas Central",
               loc_lower %in% tolower(c("Mad (W)", "Mad-w", "Mad w", "Mad(W)", "Madw", "Mad SW")) ~ "Maderas West",
               loc_lower %in% tolower(c("Mad Flats", "Mad F", "Mad flat", "Mad-F", "mad-flats", "above Maderas", "Maderas flat", "Maderas High", "mad-flat")) ~ "Maderas Flats",
               loc_lower %in% tolower(c("Mad-r", "Mad R", "Mad Ridge", "Maderas Rdg", "HD R?", "Mad B", "madridge", "Mad-ridge", "MadR")) ~ "Maderas Ridge",
